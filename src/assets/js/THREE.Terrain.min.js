...
! function(a) {
    ...
    var f = [new b(1, 1, 0), new b(-1, 1, 0), new b(1, -1, 0), new b(-1, -1, 0), new b(1, 0, 1), new b(-1, 0, 1), new b(1, 0, -1), new b(-1, 0, -1), new b(0, 1, 1), new b(0, -1, 1), new b(0, 1, -1), new b(0, -1, -1)],
        g = [151, 160, 137, 91, 90, 15, 131, 13, 201, 95, 96, 53, 194, 233, 7, 225, 140, 36, 103, 30, 69, 142, 8, 99, 37, 240, 21, 10, 23, 190, 6, 148, 247, 120, 234, 75, 0, 26, 197, 62, 94, 252, 219, 203, 117, 35, 11, 32, 57, 177, 33, 88, 237, 149, 56, 87, 174, 20, 125, 136, 171, 168, 68, 175, 74, 165, 71, 134, 139, 48, 27, 166, 77, 146, 158, 231, 83, 111, 229, 122, 60, 211, 133, 230, 220, 105, 92, 41, 55, 46, 245, 40, 244, 102, 143, 54, 65, 25, 63, 161, 1, 216, 80, 73, 209, 76, 132, 187, 208, 89, 18, 169, 200, 196, 135, 130, 116, 188, 159, 86, 164, 100, 109, 198, 173, 186, 3, 64, 52, 217, 226, 250, 124, 123, 5, 202, 38, 147, 118, 126, 255, 82, 85, 212, 207, 206, 59, 227, 47, 16, 58, 17, 182, 189, 28, 42, 223, 183, 170, 213, 119, 248, 152, 2, 44, 154, 163, 70, 221, 153, 101, 155, 167, 43, 172, 9, 129, 22, 39, 253, 19, 98, 108, 110, 79, 113, 224, 232, 178, 185, 112, 104, 218, 246, 97, 228, 251, 34, 242, 193, 238, 210, 144, 12, 191, 179, 162, 241, 81, 51, 145, 235, 249, 14, 239, 107, 49, 192, 214, 31, 181, 199, 106, 157, 184, 84, 204, 176, 115, 121, 50, 45, 127, 4, 150, 254, 138, 236, 205, 93, 222, 114, 67, 29, 24, 72, 243, 141, 128, 195, 78, 66, 215, 61, 156, 180],
        h = new Array(512),
        i = new Array(512);
    e.seed = function(a) {
    ...
    e.simplex = function(a, b) {
        ...
        return delete a._mesh, a.heightmap instanceof HTMLCanvasElement || a.heightmap instanceof Image ? THREE.Terrain.fromHeightmap(e.geometry.vertices, a) : "function" == typeof a.heightmap ? a.heightmap(e.geometry.vertices, a) : console.warn("An invalid value was passed for `options.heightmap`: " + a.heightmap), THREE.Terrain.Normalize(e, a), a.useBufferGeometry && (e.geometry = (new THREE.BufferGeometry).fromGeometry(e.geometry)), d.add(e), d
    }, THREE.Terrain.Normalize = function(a, b) {
        var c = a.geometry.vertices;
        b.turbulent && THREE.Terrain.Turbulence(c, b), b.steps > 1 && (THREE.Terrain.Step(c, b.steps), THREE.Terrain.Smooth(c, b)), THREE.Terrain.Clamp(c, b), "function" == typeof b.after && b.after(c, b), a.geometry.verticesNeedUpdate = !0, a.geometry.normalsNeedUpdate = !0, a.geometry.computeBoundingSphere(), a.geometry.computeFaceNormals(), a.geometry.computeVertexNormals()
    }, THREE.Terrain.NONE = 0, THREE.Terrain.GEOMIPMAP = 1, THREE.Terrain.GEOCLIPMAP = 2, THREE.Terrain.POLYGONREDUCTION = 3, THREE.Terrain.toArray2D = function(a, b) {
        var c = new Array(b.xSegments),
            d = b.xSegments + 1,
            e = b.ySegments + 1,
            f, g;
        for (f = 0; f < d; f++)
            for (c[f] = new Float64Array(b.ySegments), g = 0; g < e; g++) c[f][g] = a[g * d + f].z;
        return c
    }, THREE.Terrain.fromArray2D = function(a, b) {
        for (var c = 0, d = b.length; c < d; c++)
            for (var e = 0, f = b[c].length; e < f; e++) a[e * d + c].z = b[c][e]
        ...
        var c = new Array((b.xSegments + 1) * (b.ySegments + 1)),
            d = c.length,
            e;
        for (e = 0; e < d; e++) c[e] = {
            z: 0
        };
        for (b.minHeight = b.minHeight || 0, b.maxHeight = void 0 === b.maxHeight ? 1 : b.maxHeight, b.stretch = b.stretch || !1, a(c, b), THREE.Terrain.Clamp(c, b), e = 0; e < d; e++) c[e] = c[e].z;
        return c
        ...
        var c = document.createElement("canvas"),
            ...
            e = b.ySegments + 1,
            f = b.xSegments + 1,
            g = b.maxHeight - b.minHeight;
        c.width = f, c.height = e, d.drawImage(b.heightmap, 0, 0, c.width, c.height);
        for (var h = d.getImageData(0, 0, c.width, c.height).data, i = 0; i < e; i++)
            for (var j = 0; j < f; j++) {
                var k = i * f + j,
                    l = 4 * k;
        ...
        var c = void 0 === b.maxHeight,
            d = void 0 === b.minHeight,
            e = c ? b.maxHeight : -1 / 0,
            f = d ? b.minHeight : 1 / 0;
        if (!c || !d) {
            for (var g = e, h = f, i = 0, j = a.length; i < j; i++) a[i].z > g && (g = a[i].z), a[i].z < h && (h = a[i].z);
            c || (e = g), d || (f = h)
        }
        var k = b.heightmap instanceof HTMLCanvasElement ? b.heightmap : document.createElement("canvas"),
            l = k.getContext("2d"),
            m = b.ySegments + 1,
            n = b.xSegments + 1,
            o = b.maxHeight - b.minHeight;
        k.width = n, k.height = m;
        for (var p = l.createImageData(k.width, k.height), q = p.data, r = 0; r < m; r++)
            for (var s = 0; s < n; s++) {
                var t = r * n + s,
                    u = 4 * t;
        ...
        var c = 1 / 0,
            ...
            e = a.length,
            f;
        for (b.easing = b.easing || THREE.Terrain.Linear, f = 0; f < e; f++) a[f].z < c && (c = a[f].z), a[f].z > d && (d = a[f].z);
        var g = d - c,
            h = "number" != typeof b.maxHeight ? d : b.maxHeight,
            i = "number" != typeof b.minHeight ? c : b.minHeight,
            j = b.stretch ? h : d < h ? d : h,
            k = b.stretch ? i : c > i ? c : i,
            l = j - k;
        for (j < k && (j = h, l = j - k), f = 0; f < e; f++) a[f].z = b.easing((a[f].z - c) / g) * l + i
    }, THREE.Terrain.Edges = function(a, b, c, d, e, f) {
        var g = Math.floor(d / (b.xSize / b.xSegments)) || 1,
            h = Math.floor(d / (b.ySize / b.ySegments)) || 1,
            i = c ? b.maxHeight : b.minHeight,
            j = c ? Math.max : Math.min,
            k = b.xSegments + 1,
            l = b.ySegments + 1,
            m, n, o, p, q;
        for (e = e || THREE.Terrain.EaseInOut, "object" != typeof f && (f = {
            ...
            for (n = 0; n < h; n++) o = e(1 - n / h), p = n * k + m, q = (b.ySegments - n) * k + m, f.top && (a[p].z = j(a[p].z, (i - a[p].z) * o + a[p].z)), f.bottom && (a[q].z = j(a[q].z, (i - a[q].z) * o + a[q].z));
        for (m = 0; m < l; m++)
            for (n = 0; n < g; n++) o = e(1 - n / g), p = m * k + n, q = (b.ySegments - m) * k + (b.xSegments - n), f.left && (a[p].z = j(a[p].z, (i - a[p].z) * o + a[p].z)), f.right && (a[q].z = j(a[q].z, (i - a[q].z) * o + a[q].z));
        ...
        var f = c ? b.maxHeight : b.minHeight,
            g = c ? Math.max : Math.min,
            h = b.xSegments + 1,
            i = b.ySegments + 1,
            j = .5 * h,
            k = .5 * i,
            l = b.xSize / b.xSegments,
            m = b.ySize / b.ySegments,
            n = .5 * Math.min(b.xSize, b.ySize) - d,
            o, p, q, r, s;
        for (o = 0; o < h; o++)
            for (p = 0; p < k; p++) r = p * h + o, s = Math.min(n, Math.sqrt((j - o) * l * (j - o) * l + (k - p) * m * (k - p) * m) - d), s < 0 || (q = e(s / n), a[r].z = g(a[r].z, (f - a[r].z) * q + a[r].z), r = (b.ySegments - p) * h + o, a[r].z = g(a[r].z, (f - a[r].z) * q + a[r].z))
    }, THREE.Terrain.Smooth = function(a, b, c) {
        for (var d = new Float64Array(a.length), e = 0, f = b.xSegments + 1, g = b.ySegments + 1; e < f; e++)
            for (var h = 0; h < g; h++) {
                for (var i = 0, j = 0, k = -1; k <= 1; k++)
                    for (var l = -1; l <= 1; l++) {
                        var m = (h + k) * f + e + l;
                        void 0 !== a[m] && e + l >= 0 && h + k >= 0 && e + l < f && h + k < g && (i += a[m].z, j++)
                    }
                d[h * f + e] = i / j
            }
        c = c || 0;
        ...
        for (var c = new Float64Array(a.length), d = [], e = [], f = function(a, b) {
                return d[a] - d[b]
            }, g = 0, h = b.xSegments + 1, i = b.ySegments + 1; g < h; g++)
            for (var j = 0; j < i; j++) {
                d.length = 0, e.length = 0;
                for (var k = -1; k <= 1; k++)
                    for (var l = -1; l <= 1; l++) {
                        var m = (j + k) * h + g + l;
                        void 0 !== a[m] && g + l >= 0 && j + k >= 0 && g + l < h && j + k < i && (d.push(a[m].z), e.push(m))
                    }
                e.sort(f);
                var n = Math.floor(.5 * e.length),
                    o;
        ...
        for (var d = new Float64Array(a.length), e = 0, f = b.xSegments + 1, g = b.ySegments + 1; e < f; e++)
            for (var h = 0; h < g; h++) {
                for (var i = -1 / 0, j = 1 / 0, k = -1; k <= 1; k++)
                    for (var l = -1; l <= 1; l++) {
                        var m = (h + k) * f + e + l;
                        void 0 !== a[m] && k && l && e + l >= 0 && h + k >= 0 && e + l < f && h + k < g && (a[m].z < j && (j = a[m].z), a[m].z > i && (i = a[m].z))
                    }
                var n = h * f + e;
                if ("number" == typeof c) {
                    var o = .5 * (i - j),
        ...
        for (var f = b.maxHeight - b.minHeight, g = 0, h = c.length; g < h; g++) {
            var i = void 0 === c[g].amplitude ? 1 : c[g].amplitude,
                j = .5 * (f - f * i);
            d.maxHeight = b.maxHeight - j, d.minHeight = b.minHeight + j, d.frequency = void 0 === c[g].frequency ? b.frequency : c[g].frequency, c[g].method(a, d)
        }
    }, THREE.Terrain.Curve = function(a, b, c) {
        for (var d = .5 * (b.maxHeight - b.minHeight), e = b.frequency / (Math.min(b.xSegments, b.ySegments) + 1), f = 0, g = b.xSegments + 1, h = b.ySegments + 1; f < g; f++)
            for (var i = 0; i < h; i++) a[i * g + f].z += c(f * e, i * e) * d
    }, THREE.Terrain.Cosine = function(a, b) {
        for (var c = .5 * (b.maxHeight - b.minHeight), d = b.frequency * Math.PI / (Math.min(b.xSegments, b.ySegments) + 1), e = Math.random() * Math.PI * 2, f = 0, g = b.xSegments + 1; f < g; f++)
            for (var h = 0, i = b.ySegments + 1; h < i; h++) a[h * g + f].z += c * (Math.cos(f * d + e) + Math.cos(h * d + e))
        ...
        var c = THREE.Math.ceilPowerOfTwo(Math.max(b.xSegments, b.ySegments) + 1),
            d = c + 1,
            e = [],
            f = b.maxHeight - b.minHeight,
            g, h, i = b.xSegments + 1,
            j = b.ySegments + 1;
        for (g = 0; g <= c; g++) e[g] = new Float64Array(c + 1);
        for (var k = c; k >= 2; k /= 2) {
            var l = Math.round(.5 * k),
                m = Math.round(k),
                n, o, p, q, r;
            for (f /= 2, n = 0; n < c; n += m)
                for (o = 0; o < c; o += m) q = Math.random() * f * 2 - f, p = e[n][o] + e[n + m][o] + e[n][o + m] + e[n + m][o + m], p *= .25, e[n + l][o + l] = p + q;
            for (n = 0; n < c; n += l)
                for (o = (n + l) % k; o < c; o += k) q = Math.random() * f * 2 - f, p = e[(n - l + d) % d][o] + e[(n + l) % d][o] + e[n][(o + l) % d] + e[n][(o - l + d) % d], p *= .25, p += q, e[n][o] = p, 0 === n && (e[c][o] = p), 0 === o && (e[n][c] = p)
        }
        for (g = 0; g < i; g++)
            for (h = 0; h < j; h++) a[h * i + g].z += e[g][h]
    }, THREE.Terrain.Fault = function(a, b) {
        for (var c = Math.sqrt(b.xSegments * b.xSegments + b.ySegments * b.ySegments), d = c * b.frequency, e = .5 * (b.maxHeight - b.minHeight), f = e / d, g = Math.min(b.xSize / b.xSegments, b.ySize / b.ySegments) * b.frequency, h = 0; h < d; h++)
            for (var i = Math.random(), j = Math.sin(i * Math.PI * 2), k = Math.cos(i * Math.PI * 2), l = Math.random() * c - .5 * c, m = 0, n = b.xSegments + 1; m < n; m++)
                for (var o = 0, p = b.ySegments + 1; o < p; o++) {
                    var q = j * m + k * o - l;
    ...
    function() {
        function a(b, c, d, e, f) {
            for (var g = d * e + c, h = 0; h < 3; h++) {
                ...
                var i = d * e + c;
                if (void 0 !== b[i]) {
                    if (b[i].z < b[g].z) return a(b, c, d, e, f), void 0
                } else if (Math.random() < .2) return b[g].z += f, void 0
            }
            b[g].z += f
        }
        THREE.Terrain.Particles = function(b, c) {
            for (var d = Math.sqrt(c.xSegments * c.xSegments + c.ySegments * c.ySegments) * c.frequency * 300, e = c.xSegments + 1, f = (c.maxHeight - c.minHeight) / d * 1e3, g = Math.floor(Math.random() * c.xSegments), h = Math.floor(Math.random() * c.ySegments), i = .2 * Math.random() - .1, j = .2 * Math.random() - .1, k = 0; k < d; k++) {
                ...
                k % 1e3 == 0 && (i = .2 * Math.random() - .1, j = .2 * Math.random() - .1), k % 100 == 0 && (g = Math.floor(c.xSegments * (.5 + i) + Math.cos(l) * Math.random() * c.xSegments * (.5 - Math.abs(i))), h = Math.floor(c.ySegments * (.5 + j) + Math.sin(l) * Math.random() * c.ySegments * (.5 - Math.abs(j))))
            }
        }
    }(), THREE.Terrain.Perlin = function(a, b) {
        noise.seed(Math.random());
        for (var c = .5 * (b.maxHeight - b.minHeight), d = (Math.min(b.xSegments, b.ySegments) + 1) / b.frequency, e = 0, f = b.xSegments + 1; e < f; e++)
            for (var g = 0, h = b.ySegments + 1; g < h; g++) a[g * f + e].z += noise.perlin(e / d, g / d) * c
        ...
        noise.seed(Math.random());
        for (var c = .5 * (b.maxHeight - b.minHeight), d = 2 * (Math.min(b.xSegments, b.ySegments) + 1) / b.frequency, e = 0, f = b.xSegments + 1; e < f; e++)
            for (var g = 0, h = b.ySegments + 1; g < h; g++) a[g * f + e].z += noise.simplex(e / d, g / d) * c
    ...
    function() {
        function a(a, b, c, d, e, f) {
            if (!(c > d)) {
                ...
                for (g = 0; g <= i; g += k) {
                    for (h = 0; h <= j; h += k) {
                        ...
                        if (f[n] = Math.random() * e, !(l < 0 && m < 0)) {
                            for (var o = f[n], p = f[h * i + (g - k)] || o, q = f[(h - k) * i + g] || o, r = f[(h - k) * i + (g - k)] || o, s = l; s < g; s++)
                                for (var t = m; t < h; t++)
                                    if (s !== l || t !== m) {
                                        var u = t * i + s;
                                        if (!(u < 0)) {
                ...
                for (g = 0, i = b.xSegments + 1; g < i; g++)
                    for (h = 0, j = b.ySegments + 1; h < j; h++) {
                        var z = h * i + g,
                            A = h * d + g;
                        a[z].z += f[A]
                    }
        ...
        THREE.Terrain.Value = function(b, c) {
            for (var d = THREE.Math.ceilPowerOfTwo(Math.max(c.xSegments, c.ySegments) + 1), e = new Float64Array((d + 1) * (d + 1)), f = c.maxHeight - c.minHeight, g = 2; g < 7; g++) a(b, c, Math.pow(2, g), d, f * Math.pow(2, 2.4 - 1.2 * g), e);
        ...
        for (var c = .5 * (b.maxHeight - b.minHeight), d = Math.random() < .5 ? 1 : -1, e = Math.random() < .5 ? 1 : -1, f = .5 + 1 * Math.random(), g = .5 + 1 * Math.random(), h = .025 + .1 * Math.random(), i = 2 * Math.random() - 1, j = .5 + 1 * Math.random(), k = .5 + 1 * Math.random(), l = .025 + .1 * Math.random(), m = 2 * Math.random() - 1, n = 0, o = b.xSegments + 1; n < o; n++)
            for (var p = 0, q = b.ySegments + 1; p < q; p++) {
                for (var r = 0, s = 0; s < 20; s++) {
                    var t = Math.pow(1 + f, -s) * Math.sin(Math.pow(1 + g, s) * (n + .25 * Math.cos(p) + i * p) * h),
                        u = Math.pow(1 + j, -s) * Math.sin(Math.pow(1 + k, s) * (p + .25 * Math.cos(n) + m * n) * l);
        ...
        for (var c = THREE.UniformsUtils.merge([THREE.ShaderLib.lambert.uniforms]), d = "", e = "", f = a[0].texture.repeat, g = a[0].texture.offset, h = 0, i = a.length; h < i; h++)
            if (a[h].texture.wrapS = a[h].wrapT = THREE.RepeatWrapping, a[h].texture.needsUpdate = !0, c["texture_" + h] = {
                    type: "t",
                    value: a[h].texture
                ...
                var j = a[h].levels,
                    k = a[h].glsl,
                    l = void 0 !== j,
                    m = a[h].texture.repeat,
                    n = a[h].texture.offset;
                if (l) {
        ...
        if (!b.mesh) return console.error("options.mesh is required for THREE.Terrain.ScatterMeshes but was not passed"), void 0;
        if (a instanceof THREE.BufferGeometry) return console.warn("The terrain mesh is using BufferGeometry but THREE.Terrain.ScatterMeshes can only work with Geometry."), void 0;
        ...
        var e = "number" == typeof b.spread,
            f, g, h = 1 / b.smoothSpread,
            i = 2 * b.sizeVariance,
            j = a.vertices,
            k = [],
            l = b.mesh.up.clone().applyAxisAngle(new THREE.Vector3(1, 0, 0), .5 * Math.PI);
        e && (f = b.randomness(), g = "number" == typeof f ? Math.random : function(a) {
            return f[a]
        });
        for (var m = 0, n = 2 * b.w; m < n; m++)
            for (var o = 0, p = b.h; o < p; o++) {
                var q = o * n + m,
                    r = a.faces[q],
                    s = !1;
                if (e) {
        ...
        if (b.mesh.geometry instanceof THREE.Geometry) {
            ...
            for (z = 0, A = k.length; z < A; z++) b.scene.add(k[z]);
        return b.scene
        ...
        c = c || THREE.Terrain.Influences.Hill, d = void 0 === d ? .5 : d, e = void 0 === e ? .5 : e, f = void 0 === f ? 64 : f, g = void 0 === g ? 64 : g, h = void 0 === h ? THREE.NormalBlending : h, i = i || THREE.Terrain.EaseIn;
        for (var j = b.xSegments + 1, k = b.ySegments + 1, l = j * d, m = k * e, n = b.xSize / b.xSegments, o = b.ySize / b.ySegments, p = f / n, q = f / o, r = 1 / f, s = Math.ceil(l - p), t = Math.floor(l + p), u = Math.ceil(m - q), v = Math.floor(m + q), w = s; w < t; w++)
            for (var x = u; x < v; x++) {
                var y = x * j + w,
                    z = (w - l) * n,
                    A = (x - m) * o,
